    ...
    data() {
      return {
        ...
        calendarItems: [
          ...
          { id: 14, startDate: "2024-08-19", endDate: "2024-08-20", title: "Setor 1 - Crianças e adolescentes", classes: ["event-purple"] },
          ...
          { id: 19, startDate: "2024-09-06", endDate: "2024-09-08", title: "Setor 4", classes: ["event-purple"] },
          ...
          { id: 22, startDate: "2024-09-07", endDate: "2024-09-07", title: "Setor 9 - Kids", classes: ["event-purple"] },
          { id: 23, startDate: "2024-09-12", endDate: "2024-09-14", title: "Setor 13", classes: ["event-purple"] },
          { id: 25, startDate: "2024-09-12", endDate: "2024-09-15", title: "Setor 15", classes: ["event-purple"] },
          { id: 24, startDate: "2024-09-13", endDate: "2024-09-14", title: "Setor 9 - Irmãs", classes: ["event-purple"] },
          { id: 25, startDate: "2024-09-13", endDate: "2024-09-15", title: "Setor 3 - Jovens e adolescentes", classes: ["event-purple"] },
          { id: 25, startDate: "2024-09-13", endDate: "2024-09-15", title: "Setor 6", classes: ["event-purple"] },
          { id: 25, startDate: "2024-09-13", endDate: "2024-09-15", title: "Setor 14 - Jovens e Adolesc", classes: ["event-purple"] },
          { id: 25, startDate: "2024-09-13", endDate: "2024-09-15", title: "Setor 19", classes: ["event-purple"] },
          ...
          { id: 29, startDate: "2024-09-26", endDate: "2024-09-29", title: "Setor 10", classes: ["event-purple"] },
          { id: 29, startDate: "2024-09-27", endDate: "2024-09-28", title: "Setor 18", classes: ["event-purple"] },
          { id: 30, startDate: "2024-09-27", endDate: "2024-09-29", title: "Setor 17 - Jovens", classes: ["event-purple"] },
          { id: 31, startDate: "2024-10-04", endDate: "2024-10-06", title: "Setor 12", classes: ["event-purple"] },
          { id: 32, startDate: "2024-10-04", endDate: "2024-10-06", title: "Setor 14 - Irmãs", classes: ["event-purple"] },
          { id: 33, startDate: "2024-10-04", endDate: "2024-10-06", title: "Setor 16 - Irmãs", classes: ["event-purple"] },
          ...
          { id: 43, startDate: "2024-10-25", endDate: "2024-10-27", title: "Setor 1 - Irmãs e Jovens", classes: ["event-purple"] },
          { id: 44, startDate: "2024-10-25", endDate: "2024-10-27", title: "Setor 2", classes: ["event-purple"] },
          { id: 45, startDate: "2024-10-25", endDate: "2024-10-27", title: "Setor 9 - Jovens e Adolescentes", classes: ["event-purple"] },
          ...
          { id: 49, startDate: "2024-11-07", endDate: "2024-11-10", title: "Setor 16 - Unificado", classes: ["event-purple"] },
          { id: 50, startDate: "2024-11-07", endDate: "2024-11-11", title: "Setor 5", classes: ["event-purple"] },
          { id: 51, startDate: "2024-11-08", endDate: "2024-11-10", title: "Setor 3 - Irmãs", classes: ["event-purple"] },
          { id: 53, startDate: "2024-11-09", endDate: "2024-11-10", title: "Setor 20", classes: ["event-purple"] },
          ...
          { id: 54, startDate: "2024-11-16", endDate: "2024-11-16", title: "Setor 9 - Missões", classes: ["event-purple"] },
          { id: 54, startDate: "2024-11-22", endDate: "2024-11-24", title: "Setor 8", classes: ["event-purple"] },
          { id: 54, startDate: "2024-11-22", endDate: "2024-11-23", title: "Setor 20", classes: ["event-purple"] },
          ...
          { id: 54, startDate: "2024-12-06", endDate: "2024-12-08", title: "Setor 11", classes: ["event-purple"] },
