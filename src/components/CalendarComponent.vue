    ...
    data() {
        return {
            ...
            calendarItems: [
                ...
                { id: 15, startDate: "2024-08-19", endDate: "2024-08-19", title: "Pr. Jorge Franco", classes: ["event-write"] },
                ...
                { id: 27, startDate: "2024-09-21", endDate: "2024-09-21", title: "Culto AADECAAMP", classes: ["event-write"] },
